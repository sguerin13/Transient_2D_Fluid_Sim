...
class Encoder(nn.Module):
    def __init__(self):
        ...
        # downsample
        self.conv23  = nn.Conv2d(64,64,2,stride = 2)
        torch.nn.init.xavier_uniform(self.conv23.weight)
        self.bn23   = nn.BatchNorm2d(64)

        # third block - 16 x 32
        self.conv31  = nn.Conv2d(64,128,3,stride = 1,padding=1)
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.bn32    = nn.BatchNorm2d(128)
        self.dconv33  = nn.ConvTranspose2d(128,128,2,stride = 2)
        torch.nn.init.xavier_uniform(self.dconv33.weight)
        self.bn33    = nn.BatchNorm2d(128)
        

        # 4th block - 32 x 64
        self.dconv41  = nn.Conv2d(128,64,3,stride = 1,padding=1)
