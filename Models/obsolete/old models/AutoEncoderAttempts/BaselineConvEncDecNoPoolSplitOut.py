...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv11  = nn.Conv2d(4,32,3,stride = 1,padding=1)
        ...
        # downsample
        self.conv13  = nn.Conv2d(32,32,3,stride = 2,padding=1)
        ...
        # downsample
        self.conv23  = nn.Conv2d(32,32,3,stride = 2,padding=1)
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        ###########################
        # o = (i-1)*s + k -2p
        # split the decoder out to 3 separate branches
