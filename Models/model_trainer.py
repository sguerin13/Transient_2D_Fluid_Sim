...
class TrainerXY():
    ...
    def build_data_loaders(self):
        if self.val_split is not None:
            ...
            self.dloader = DataLoader(self.train_set,batch_size=self.batch_size,pin_memory=True,shuffle=True,drop_last=False)
            self.val_dloader = DataLoader(self.val_set,batch_size=int(self.batch_size/2),pin_memory=True,shuffle=True,drop_last=False)
        else:
